...
public class ConfessionModalListener implements EventListener<ModalSubmitInteractionEvent> {
    ...
    return guildSettingsProvider
        ...
        .flatMap(
            settings -> {
              ...
              if (customId.startsWith(REPLY_MODAL_PREFIX))
                return handleReply(event, customId, locale, settings);
                                ...
                                channels -> {
                                          ...
                                          .filter(
                                              channel ->
                                                  matchesConfiguredChannel(
                                                      channel,
                                                      settings.getConfessionsChannelId(),
                                                      "confessions"))
                                          .findFirst()
                                          .orElse(null);
                                            ...
                                            .filter(
                                                channel ->
                                                    channel
                                                        ...
                                                        .asString()
                                                        .equals(
                                                            settings.getConfessionsLogChannelId()))
                                            .findFirst()
                                            .orElse(null);
                                  }
                                      ...
                                      EmbedCreateSpec.builder()
                                          .title(
                                              i18nManager.localize(
                                                  "confessions.embed.title", locale))
                                  ...
                                  Button confessionButton =
                                      Button.primary(
                                          ...
                                          Emoji.unicode("\uD83E\uDD2B"),
                                          i18nManager.localize(
                                              "confessions.button.submit", locale));
                                                  ...
                                                  publicMessage
                                                      ...
                                                      .withComponents(
                                                          ActionRow.of(
                                                              confessionButton,
                                                              Button.secondary(
                                                                  ConfessionButtonListener
                                                                          .REPLY_BUTTON_PREFIX
                                                                      + publicMessage
                                                                          .getId()
                                                                          .asString(),
                                                                  i18nManager.localize(
                                                                      "confessions.button.reply",
                                                                      locale))))
                                                      .then());
                                  ...
                                  if (logChannel != null) {
                                    EmbedCreateSpec.Builder logEmbedBuilder =
                                        EmbedCreateSpec.builder()
                                            .title(
                                                i18nManager.localize(
                                                    "confessions.log.title", locale))
                                            .description(confessionMessage)
                                            .addField(
                                                i18nManager.localize(
                                                    "confessions.log.author", locale),
                                                author.getMention()
                                                    + " ("
            ...
            event
                ...
                .flatMap(
                    channel -> {
                      ...
                      EmbedCreateSpec replyEmbed =
                          EmbedCreateSpec.builder()
                              .title(i18nManager.localize("confessions.reply.embed.title", locale))
                              .description(reply)
                              .addField(
                                  i18nManager.localize(
                                      "confessions.reply.embed.response_to", locale),
                                  "[View confession](" + confessionLink + ")",
                                  false)
                              .color(CONFESSION_BLUE)
                              .build();

                      Mono<Void> sendPublic = channel.createMessage(replyEmbed).then();
                                  ...
                                  logChannel
                                      .createMessage(
                                          EmbedCreateSpec.builder()
                                              .title(
                                                  i18nManager.localize(
                                                      "confessions.reply.log.title", locale))
                                              .description(reply)
                                              .addField(
                                                  i18nManager.localize(
  ...
  private Mono<TextChannel> findLogChannel(
      ModalSubmitInteractionEvent event, GuildSettings settings) {
  ...
  private boolean matchesConfiguredChannel(
      TextChannel channel, String configuredChannelId, String fallbackName) {
