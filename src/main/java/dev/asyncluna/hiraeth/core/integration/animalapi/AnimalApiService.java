...
public class AnimalApiService {
  ...
  public Mono<String> getRandomAnimalImageUrl(AnimalApiType animalType) {
    log.debug("Fetching random animal image URL from Animality API for animalType={}", animalType);
  ...
  public Mono<String> getRandomAnimalFact(AnimalApiType animalType) {
    log.debug("Fetching random animal fact from Animality API for animalType={}", animalType);
